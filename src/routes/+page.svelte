    ...
    <div class='flex justify-center items-center mt-44 px-10'>
        <div>
            ...
            <div class='flex flex-row items-center mb-3'>
                <pre class='text-1xl font-bold mx-7 font-sans'>To start  <button on:click={onClickCreateRandom} class='bg-green-700 px-2 py-1 rounded-md text-gray-300 border-2 border-green-800 hover:border-amber-200'>generate a link</button>  and share it with you peers</pre>
            </div>
            {#if shouldDisableCreate}
                <div class='w-full ml-10 flex flex-row'>
                    ...
                    <button id='copy-button' on:click={onCopyClick} class='bg-green-700 px-2 py-1 ml-2 rounded-md text-gray-300 font-bold border-2 border-green-800 hover:border-amber-200'>copy</button>
